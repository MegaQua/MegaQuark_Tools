...
class BWTool(QtWidgets.QWidget):
    ...
    ATTR_SEP   = "__________________________________"         # visual separator (displayable)
    SEP_TEXT   = ""
    ...
    def ensure_ctrl(self):
        ...
        _add_double(ctrl, self.ATTR_MONO, 1.0, 0.0, 1.0, keyable=True)   # 0 unchanged — 1 grayscale (final)
